...
| SW003 | Arbitrary CPI target         | Critical | Unvalidated CPI program (`invoke`/`invoke_signed`); stronger message when a `Signer` is also passed (confused deputy / malicious royalty program)                           |
